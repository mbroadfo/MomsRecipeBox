...
1. **Complete connection URI**:
   ...
   ```env
   MONGODB_ATLAS_URI=mongodb+srv://<username>:<password>@<cluster>.mongodb.net/moms_recipe_box
   ```
...
```powershell
.\scripts\Compare-MongoDB.ps1 -LocalUri "mongodb://<username>:<password>@localhost:27017/moms_recipe_box_dev" -AtlasUri "mongodb+srv://<username>:<password>@<cluster>.mongodb.net/moms_recipe_box_dev"
```
