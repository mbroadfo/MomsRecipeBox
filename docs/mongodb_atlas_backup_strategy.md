...
resource "aws_lambda_function" "mongodb_atlas_backup" {
  ...
  environment {
    variables = {
      MONGODB_URI      = "mongodb+srv://mrbapp:${local.mongodb_atlas_password}@${mongodbatlas_cluster.momsrecipebox_cluster.name}.${mongodbatlas_cluster.momsrecipebox_cluster.connection_strings[0].private_endpoint}/momsrecipebox?retryWrites=true&w=majority"
