...
```powershell
aws secretsmanager update-secret --secret-id moms-recipe-secrets-dev --secret-string "{\"MONGODB_URI\":\"mongodb+srv://mrbapp:<PASSWORD>@<CLUSTER_NAME>.mongodb.net/momsrecipebox?retryWrites=true&w=majority\"}"
```
