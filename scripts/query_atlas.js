...
const uri = process.env.MONGODB_ATLAS_URI || 'mongodb+srv://mrbapp:${MONGODB_PASSWORD}@momsrecipebox-cluster.vohcix5.mongodb.net/moms_recipe_box_dev?retryWrites=true&w=majority';
